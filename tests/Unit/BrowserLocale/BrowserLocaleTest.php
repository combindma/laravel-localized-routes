...
namespace CodeZero\LocalizedRoutes\Tests\Unit\BrowserLocale;

use CodeZero\LocalizedRoutes\BrowserLocale\BrowserLocale;
use CodeZero\LocalizedRoutes\BrowserLocale\Filters\Filter;
use Mockery;
...
{
    #[Test]
    public function it_returns_the_most_preferred_locale(): void
    {
    ...
    #[Test]
    public function it_returns_the_first_locale_if_two_have_the_same_weight(): void
    {
    ...
    #[Test]
    public function it_returns_an_array_of_all_preferred_locales(): void
    {
        $browser = new BrowserLocale('en-US,en;q=0.8,nl-NL;q=0.6,nl;q=0.4');
    ...
    #[Test]
    public function it_returns_null_or_an_empty_array_if_no_locale_exists(): void
    {
    ...
    #[Test]
    public function it_returns_null_or_an_empty_array_if_null_is_passed_in(): void
    {
    ...
    #[Test]
    public function it_applies_a_filter_to_the_locales(): void
    {
        $browser = new BrowserLocale('');
